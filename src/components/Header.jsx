...
const Header = () => {
  ...
  <button
    ...
    className="flex items-center cursor-pointer space-x-2 p-2 rounded-full hover:bg-gray-100 transition-colors"
  >
  ...
  {showProfileDropdown && (
    <div
      ...
      onMouseLeave={() => setShowProfileDropdown(false)} // 👈 auto-close on mouse leave
    >
      <button
        onClick={() => {
          navigate("/profile");
